...
return [
    ...
    'rejections' => [
        'working' => '<strong>Thank you for your interest in FUNVAL\'s program.</strong><br/>Due to the intensive nature of our training, this program is designed for individuals who are currently unemployed.<br/><br/>If in the future you find yourself looking for a job, do not hesitate to contact us again.<br/><br/>We would also like to share information about some partner organizations that might be of interest to you: <a href="https://www.the-academy.org/contact/" target="_blank" class="text-blue-600 underline">The Academy</a> and <a href="https://mentorseducation.org/" target="_blank" class="text-blue-600 underline">Mentors</a>.',

        'entrepreneur' => '<strong>Excellent!</strong><br/>You will soon receive information about our partner organizations specializing in entrepreneurship, which share FUNVAL\'s commitment to providing new opportunities for people like you.<br/><br/>Please visit the following links for more information about these organizations: <a href="https://www.the-academy.org/contact/" target="_blank" class="text-blue-600 underline">The Academy</a> and <a href="https://mentorseducation.org/" target="_blank" class="text-blue-600 underline">Mentors</a>.',

        'online_part_time' => '<strong>FUNVAL maintains partnerships with companies that require on-site work.</strong><br/><br/>If in the future this option fits your situation, please do not hesitate to contact us again. We will be glad to support your job search.<br/><br/>We would also like to share information about some partner organizations that might be of interest to you: <a href="https://www.the-academy.org/contact/" target="_blank" class="text-blue-600 underline">The Academy</a> and <a href="https://mentorseducation.org/" target="_blank" class="text-blue-600 underline">Mentors</a>.',

        'part_time' => '<strong>Due to the intensive nature of the program</strong>, all participants are required to have a stable and reliable internet connection, and to be fully available during the training schedule, without any parallel activities.<br/><br/>If in the future this option fits your situation, please do not hesitate to contact us again. We will be glad to support your job search.<br/><br/>We would also like to share information about some partner organizations that might be of interest to you: <a href="https://www.the-academy.org/contact/" target="_blank" class="text-blue-600 underline">The Academy</a> and <a href="https://mentorseducation.org/" target="_blank" class="text-blue-600 underline">Mentors</a>.',
    ],
