...
export default function AuthSimpleLayout({ children, title, description }: PropsWithChildren<AuthLayoutProps>) {
    return (
        <div className="flex min-h-screen items-center justify-center bg-gray-200 p-6 text-black">
            <div className="w-120 rounded-2xl px-8 py-10 bg-gray-50 border border-blue-100 shadow-2xl"> 
