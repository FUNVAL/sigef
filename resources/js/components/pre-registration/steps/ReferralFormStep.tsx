      ...
      <Card className="border-2">
        <CardHeader className="text-center pb-4">
          <div className="mx-auto w-16 h-16 rounded-full bg-funval-blue/10 flex items-center justify-center mb-4">
            <Users className="h-8 w-8 text-funval-blue" />
          </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <Select value={formData.relacionConReferido} onValueChange={(value) => updateFormData('relacionConReferido', value)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="conocido">Conocido/a</SelectItem>
                      <SelectItem value="companero_iglesia">Compañero de iglesia</SelectItem>
                      <SelectItem value="vecino">Vecino/a</SelectItem>
                      <SelectItem value="companero_trabajo">Compañero de trabajo</SelectItem>
