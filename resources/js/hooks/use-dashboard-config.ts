    ...
    const createReferencesConfig = (overrides: Partial<DashboardConfig> = {}): DashboardConfig => {
        const defaultConfig: DashboardConfig = {
            ...
            sectionTitles: {
                ...
                byStake: 'Referencias Pendientes por Reclutador',
                byStakeDescription: 'Referencias pendientes de revisión agrupadas por reclutador responsable',
    ...
    const createPreInscriptionsConfig = (overrides: Partial<DashboardConfig> = {}): DashboardConfig => {
        const defaultConfig: DashboardConfig = {
            ...
            sectionTitles: {
                ...
                byStake: 'Preinscripciones Pendientes por Reclutador',
                byStakeDescription: 'Preinscripciones pendientes de revisión agrupadas por reclutador responsable',
                pendingActions: 'Acciones Pendientes',
